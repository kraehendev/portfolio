...
export default function Airplane({
  ...
  const body = (
    <>
      ...
      <path
        style={{ fill: accentColor }}
        d="M277.742,310.365h44c2.572,0,4.657-2.085,4.657-4.657v-18c0-2.572-2.085-4.657-4.657-4.657h-44c-8.699,0-15.751,7.052-15.751,15.751l0,0C261.992,303.313,269.044,310.365,277.742,310.365z"
      />
      {/* Elevator */}
      <path
        style={{ fill: '#b5b5b5' }}
        d="M67.992,238.464H7.5c-4.142,0-7.5-3.358-7.5-7.5s3.358-7.5,7.5-7.5h60.492c4.142,0,7.5,3.358,7.5,7.5S72.134,238.464,67.992,238.464z"
      />
      {/* Wing */}
      <path
        style={{ fill: '#b5b5b5' }}
        d="M312.492,287.364h-84.667c-4.142,0-7.5-3.358-7.5-7.5s3.358-7.5,7.5-7.5h84.667c4.142,0,7.5,3.358,7.5,7.5S316.634,287.364,312.492,287.364z"
      />
      {/* Winglet */}
      ...
      <path
        style={{ fill: '#000000' }}
        d="M445.639,254.964h-11.15c-6.07,0-11-4.92-11-11h12.48c0.13,0.16,0.23,0.32,0.34,0.49c2.01,3.14,4.4,6,7.09,8.54C444.119,253.674,444.869,254.334,445.639,254.964z"
      />
      {/* Nose */}
      <path
        style={{ fill: '#b5b5b5' }}
